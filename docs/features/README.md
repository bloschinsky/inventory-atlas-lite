...
| [AI Add Item](ai-add-item.md) | Analyze the original photo with OpenAI, optionally remove its background locally, and review the editable draft before saving. |
